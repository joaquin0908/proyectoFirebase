const ButtonLoading = ({ colorLoading = "purple" }) => {
  const colorClass =
    colorLoading === "red"
      ...
      : "bg-purple-700 hover:bg-purple-800 focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800"; // Default color

  return (
    <button
      disabled
      type="button"
      className={`text-white ${colorClass} font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 inline-flex items-center`}
    >
      <svg
        aria-hidden="true"
        role="status"
